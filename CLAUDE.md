...
- `minimumReleaseAge: 10080` in `pnpm-workspace.yaml` — pnpm rejects packages published less than 7 days ago (supply chain protection). Override with `pnpm install --minimum-release-age=0` when needed.
